...
all_files <- dir("web-of-life_2020-01-15_120715/")
...
web <- read.csv(paste0("web-of-life_2020-01-15_120715/", all_webs[1]))
...
for (i in 1:length(all_webs)) {
  ...
  tmp <- sign(read.csv(paste0("web-of-life_2020-01-15_120715/", all_webs[i])))
...
testA <- read.table("web-of-life_2020-01-15_120715/interactions.txt", header = TRUE)
