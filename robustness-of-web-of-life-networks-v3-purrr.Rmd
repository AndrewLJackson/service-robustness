...
A function to calculate fragility.

fragility  f=-log(N)/\log(q)/S where q=1-p and p is the connectance estimated as p~#links/(SxN). I wrote this more cleanly in overleaf. 
